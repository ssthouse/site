const plotByName = {
    ...
    guide:  { index: 8,  icon: 'icon-guide', url: '${base}zh-cn/f2/3.x/demo/index.html#_Guide-使用', name: 'Guide 使用', },
    legend:  { index: 9,  icon: 'icon-legend', url: '${base}zh-cn/f2/3.x/demo/index.html#_Legend-使用', name: 'Legend 使用', },
    tooltip:  { index: 10,  icon: 'icon-tooltip', url: '${base}zh-cn/f2/3.x/demo/index.html#_Tooltip-使用', name: 'Tooltip 使用', },
    axis:  { index: 11,  icon: 'icon-axis', url: '${base}zh-cn/f2/3.x/demo/index.html#_坐标轴-使用', name: '坐标轴 使用', },
    other:  { index: 12, icon: 'icon-other', url: '${base}zh-cn/f2/3.x/demo/index.html#_其他图表', name: '其他图表', },
};
module.exports = {
    plotByName,
};
